<aside class="text-white w-52 flex-shrink-0 hidden bg-dgreen bg-cover bg-center lg:block" style="background-image: url('{{ asset('images/pattern.png') }}');">
    <div class="flex items-center justify-between pt-8 pb-4">
        <a class="flex items-center justify-center w-full" href="#">
            <div class="flex-1 flex justify-center items-center">
                ...
                <div class="ml-2">
                    <span
                        class="block font-semibold text-lwhite transition-all text-body duration-200 mr-4">IQACS - ITIK</span>
                </div>
            </div>
        </a>
    </div>
