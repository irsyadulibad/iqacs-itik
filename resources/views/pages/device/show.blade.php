    ...
    <div class="grid lg:grid-cols-[65%_35%] gap-4">
        ...
        <div class="bg-dprimary rounded-lg">
            ...
            >
                ...
                <div class="space-y-5">
                    <div class="relative">
                        <div
                            ...
                            class="-top-3 w-[2px] h-[50px] absolute bg-black"
                        ></div>
                        <div
                            class="w-full p-3 rounded-full bg-gradient-to-r from-red-600 via-yellow-300 to-green-500"
                        ></div>
                    </div>
                ...
                <p class="text-center text-lg">Temperature (CH4) Saat ini</p>
            </div>
        </div>
    </div>
